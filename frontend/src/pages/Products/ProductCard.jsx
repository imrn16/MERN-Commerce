			...
			<div
				...
				<div className="h-1/2 rounded-2xl relative">
					...
					<img
						...
						onLoad={() => setLoaded(true)}
						onError={() => setLoaded(true)}
						className={`w-full h-full max-h-fits object-contain aspect-auto rounded-xl transition-opacity duration-300 ${
							loaded ? "opacity-100" : "opacity-0"
						}`}
					/>
				</div>
				...
				<div className="h-1/2 overflow-hidden">
					<div
						...
						className="h-1/4 overflow-hidden rounded-xl flex items-center justify-center font-bold px-2 hover:h-auto hover:min-h-[25%]">
						<p className="truncate hover:whitespace-normal ">{p?.name}</p>
					</div>
					...
					<div
						...
						className="h-1/4 text-center flex items-center justify-center">
						<Ratings value={p.rating} />
					</div>
					...
					<div
						...
						className="h-1/4 rounded-xl text-center flex items-center justify-center font-bold">
						<span
							style={{
								fontSize: `${componentWidth * 0.075}px`,
							}}>
